...
public class DIBasedServiceFactory : IServiceFactory
{
    ...
    {
        Func<ManualModeratorParameters, IEncryptTaskModerator> factory = _serviceProvider.GetRequiredService<Func<ManualModeratorParameters, IEncryptTaskModerator>>();
    ...
    {
        Func<ManualModeratorParameters, IDecryptTaskModerator> factory = _serviceProvider.GetRequiredService<Func<ManualModeratorParameters, IDecryptTaskModerator>>();
        return factory(moderatorParameters);
    }
}
